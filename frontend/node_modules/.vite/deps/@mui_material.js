...
} from "./chunk-APOXCRG5.js";
import "./chunk-5G5JEI57.js";
import {
  Toolbar_default,
  getToolbarUtilityClass,
  toolbarClasses_default
} from "./chunk-KQ32X7KL.js";
import {
  Typography_default,
  getTypographyUtilityClass,
  typographyClasses_default
} from "./chunk-B4ZW4VSN.js";
import {
  capitalize_default
} from "./chunk-QP4JIG2J.js";
import {
...
var SliderTrack = styled_default("span", {
  ...
  const color = (
    ...
    theme.palette.mode === "light" ? (0, import_colorManipulator17.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator17.darken)(theme.palette[ownerState.color].main, 0.5)
  );
  return _extends({
    display: "block",
    position: "absolute",
...
var SliderThumb = styled_default("span", {
  ...
  [`&:hover, &.${sliderClasses_default.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator17.alpha)(theme.palette[ownerState.color].main, 0.16)}`,
    "@media (hover: none)": {
      boxShadow: "none"
    }
  },
  [`&.${sliderClasses_default.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator17.alpha)(theme.palette[ownerState.color].main, 0.16)}`
  },
  [`&.${sliderClasses_default.disabled}`]: {
    "&:hover": {
      boxShadow: "none"
...
var SwitchSwitchBase = styled_default(SwitchBase_default, {
  ...
  [`&.${switchClasses_default.checked}`]: {
    color: (theme.vars || theme).palette[ownerState.color].main,
    "&:hover": {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : (0, import_colorManipulator21.alpha)(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
    },
    [`&.${switchClasses_default.disabled}`]: {
      color: theme.vars ? theme.vars.palette.Switch[`${ownerState.color}DisabledColor`] : `${theme.palette.mode === "light" ? (0, import_colorManipulator21.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator21.darken)(theme.palette[ownerState.color].main, 0.55)}`
    }
  },
  [`&.${switchClasses_default.checked} + .${switchClasses_default.track}`]: {
    backgroundColor: (theme.vars || theme).palette[ownerState.color].main
